package com.tandev.locket.common.network;

import android.util.Log;

import androidx.annotation.NonNull;

import com.tandev.locket.common.utils.HeaderConstants;
...
public class ApiCaller {
    ...
    public void startUploadImage(String idUser, String idToken, byte[] image, com.tandev.locket.common.network.ApiCaller.UploadCallback callback) {
    ...
    private void uploadImage(String uploadUrl, byte[] image, String idUser, String nameImg, String idToken, com.tandev.locket.common.network.ApiCaller.UploadCallback callback) {
    ...
    private void getDownloadTokenImage(String getUrl, Map<String, String> getHeaders, com.tandev.locket.common.network.ApiCaller.UploadCallback callback) {
    ...
    public void postImage(String idUser, String idToken, String caption, byte[] image, com.tandev.locket.common.network.ApiCaller.UploadCallback callback) {
